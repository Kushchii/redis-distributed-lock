...
public class TransactionServiceImpl implements TransactionService {
    ...
    private Mono<TransactionsEntity> processTransactionAndSave(TransactionsRequest request) {
        ...
        return transactionRepository.save(entity)
                .doOnSuccess(savedEntity -> log.info("Transaction entity saved: {}", savedEntity.getId()));
    }
    ...
    private Mono<TransactionsResponse> releaseLock(RLockReactive lock) {
        return Mono.fromRunnable(lock::unlock)
                .doOnTerminate(() -> log.info("Lock released"))
                .thenReturn(new TransactionsResponse("Lock released successfully"));
    }
}
